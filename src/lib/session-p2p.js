/**
 * Session de collaboration en pair-à-pair (WebRTC via PeerJS). C'est le transport de
 * repli : Supabase assure l'ordinaire, celui-ci prend la main quand on coupe l'interrupteur
 * — réseau local sans internet, ou envie de ne dépendre d'aucun service.
 *
